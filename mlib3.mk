...
MLIB3SRC = ${MLIB3DIR}/mlib3analyze.cpp ${MLIB3DIR}/mlib3common.cpp ${MLIB3DIR}/mlib3math.cpp ${MLIB3DIR}/mlib3volume.cpp ${MLIB3DIR}/anyoption.cpp ${MLIB3DIR}/lodepng.cpp
